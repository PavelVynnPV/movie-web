        ...
        {activeCategory && (
          <ul className={styles.accordion__content}>
            <Link
              to="/movie-web/films"
              onClick={(e) => {
                setWebHref("https://pavelvynnpv.github.io/movie-web/films");
              }}
            >
              {" "}
            ...
            <Link
              ...
              onClick={(e) => setWebHref("https://pavelvynnpv.github.io/movie-web/serials")}
            >
              <li className={styles.accordion__content_item}>
            ...
            <Link
              to="/movie-web/anime"
              onClick={(e) => setWebHref("https://pavelvynnpv.github.io/movie-web/anime")}
            >
              <li
                className={
                  !activeCategory === true
          ...
          <ul className={styles.accordion__content}>
            {newYearArray.map((item) => (
              <Link
                ...
                onClick={(e) => setWebHref("https://pavelvynnpv.github.io/movie-web/filteryear")}
              >
                <li
          ...
          <ul className={styles.accordion__content}>
            {newCoutryArray.map((item) => (
              <Link
                ...
                onClick={(e) =>
                  setWebHref("https://pavelvynnpv.github.io/movie-web/filtercountry")
                }
              >
                <li
                  className={styles.accordion__content_item}
          ...
          <ul className={styles.accordion__content}>
            {newMovieTimeArray.map((item) => (
              <Link
                ...
                onClick={(e) =>
                  setWebHref("https://pavelvynnpv.github.io/movie-web/filtermovietime")
                }
              >
                <li
                  className={styles.accordion__content_item}
